...
var middlewareSecret = "1714e231-55a9-4962-ad89-8330ada67d6f";
//#endregion
...
var _page0 = () => import("./chunks/generic_CYFip7f-.mjs");
var _page1 = () => import("./chunks/contact_DvSEXJQT.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "1714e231-55a9-4962-ad89-8330ada67d6f") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
